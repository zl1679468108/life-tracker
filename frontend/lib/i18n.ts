...
const translations = {
  'zh-CN': {
    ...
    messages: {
      ...
      noConversationsDesc: '分享物品或待办时会自动创建对话',
      noMessages: '暂无消息',
      noMessagesDesc: '开始一段对话吧',
      clickToView: '点击查看详情',
      ...
      systemWelcome: '欢迎使用 LifeTracker 消息功能',
      shareSuccess: '分享成功',
      shareSuccessDesc: '已自动创建对话',
    },
  },
  en: {
    common: {
    ...
    messages: {
      ...
      noConversationsDesc: 'Sharing an item or todo will create a conversation',
      noMessages: 'No messages',
      noMessagesDesc: 'Start a conversation',
      clickToView: 'Tap to view details',
      inputPlaceholder: 'Type a message...',
      systemNotification: 'System notification',
      empty: '(empty message)',
      shareItem: 'Shared an item',
      shareTodo: 'Shared a todo',
      justNow: 'Just now',
      ...
      systemWelcome: 'Welcome to LifeTracker messaging',
      shareSuccess: 'Share successful',
      shareSuccessDesc: 'Conversation created automatically',
    },
  },
};
